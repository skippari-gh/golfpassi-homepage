...
const benefits = [
  {
    ...
    text: "Lennot, majoitus, golf ja kuljetukset – me hoidamme yksityiskohdat.",
    icon: CheckCircle2,
  },
  {
    title: "Et tarvitse vuokra-autoa",
    text: "Valitsemme kohteet, joissa pääset kentälle helposti ilman autoa.",
    icon: Car,
  },
  {
    title: "Kentät ja aikataulut suunniteltu",
    text: "Parhaat peliajat ja sujuva aikataulu takaavat onnistuneen matkan.",
    icon: Flag,
  },
  {
    title: "Tuki suomeksi koko matkan ajan",
    text: "Olemme tavoitettavissa ennen matkaa, matkan aikana ja sen jälkeen.",
    icon: Headphones,
  },
];
...
export default function Home() {
  return (
    <main className="min-h-screen bg-white text-golfNavy">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm font-semibold lg:flex">
            {[
              ...
              <a key={item} href="#" className="hover:text-golfBlue">
                {item}
              </a>
            ))}
          </nav>
          ...
          <a
            ...
            className="hidden items-center gap-3 rounded-full px-4 py-2 text-sm font-bold text-golfBlue hover:bg-blue-50 md:flex"
          >
      ...
      <section className="relative flex h-[80vh] min-h-[620px] items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#003c70]/90 via-[#003c70]/65 to-transparent" />
        </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-24 text-white">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-2xl text-xl font-semibold leading-relaxed text-white/90 md:text-2xl">
              Kaikki on valmiina – lennot, hotelli, golf ja kuljetukset. Sinä
              keskityt peliin.
            </p>
            ...
            {tripTypes.map((type) => {
              ...
              return (
                <a
                  key={type.title}
                  href="#matkat"
                  className="group flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:-translate-y-1 hover:border-golfBlue hover:shadow-soft"
                >
                  <span className="flex items-center gap-4">
                    <Icon className="h-10 w-10 text-golfOrange" />
                    <strong className="text-lg">{type.title}</strong>
                  </span>
            ...
            return (
              <div key={benefit.title} className="rounded-3xl bg-slate-50 p-7">
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-blue-100">
                  <Icon className="h-7 w-7 text-golfBlue" />
                </div>
      ...
      <section id="matkat" className="bg-slate-50 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-8 flex items-end justify-between gap-6">
            ...
            <a href="#" className="hidden font-bold text-golfBlue md:block">
              Katso kaikki matkat →
            </a>
          </div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right">
                      <small className="text-slate-500">alkaen</small>
                      <p className="text-2xl font-black">{trip.price}</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-3">
                    <a
                      href="#"
                      className="rounded-xl bg-golfOrange px-4 py-3 text-center text-sm font-black text-white hover:bg-orange-500"
                    >
                      Katso matka
                    </a>
                    <a
                      href="mailto:info@golfpassi.fi"
                      className="rounded-xl border border-golfBlue px-4 py-3 text-center text-sm font-black text-golfBlue hover:bg-blue-50"
                    >
                      Kysy tästä
                    </a>
                  </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-4">
          {[
            [
              "Yksin matkustavalle",
              "Turvallista, helppoa ja aina seuraa saatavilla.",
            ],
            [
              "Kaveriporukalle",
              "Porukalla vielä hauskempaa – me huolehdimme järjestelyistä.",
            ],
            [
              "Paljon pelaavalle",
              "Huolella valitut kentät ja sujuvat peliaikataulut.",
            ],
            [
              "Rennolle lomagolfarille",
              "Golfia sopivasti ja aikaa myös muille elämyksille.",
            ],
          ].map(([title, text]) => (
            <div
              key={title}
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[1.3fr_0.7fr]">
          <div className="rounded-3xl bg-white/10 p-8">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              {[
                [
                  "1",
                  "Valitse kiinnostava matka",
                  "Löydä itsellesi sopiva kohde ja ajankohta.",
                ],
                [
                  "2",
                  "Tarkista vapaat paikat",
                  "Näet varausjärjestelmässä vapaat paikat ja hinnat.",
                ],
                [
                  "3",
                  "Lähde matkaan",
                  "Me hoidamme järjestelyt. Sinä keskityt peliin.",
                ],
              ].map(([num, title, text]) => (
                <div key={num}>
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-golfBlue text-xl font-black">
                    {num}
                  </div>
          ...
          <div className="rounded-3xl bg-white p-8 text-golfNavy shadow-soft">
            ...
            <div className="mt-6 grid gap-3">
              <a
                href="tel:+358401234567"
                className="inline-flex items-center justify-center gap-3 rounded-xl bg-golfOrange px-5 py-4 font-black text-white"
              >
                <Phone className="h-5 w-5" /> Soita 040 123 4567
              </a>
              <a
                href="mailto:info@golfpassi.fi"
                className="inline-flex items-center justify-center gap-3 rounded-xl border border-golfBlue px-5 py-4 font-black text-golfBlue"
              >
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 gap-2 bg-white p-3 shadow-[0_-10px_30px_rgba(0,60,112,0.15)] md:hidden">
        <a
          href="tel:+358401234567"
          className="rounded-xl bg-golfOrange py-3 text-center font-black text-white"
        >
          Soita
        </a>
        <a
          href="#matkat"
          className="rounded-xl bg-golfNavy py-3 text-center font-black text-white"
        >
          Katso matkat
        </a>
      </div>
